...
const DashboardContent: React.FC = () => {
	...
	const getSummaryData = (year: number) => {
		...
		const reviewTotal =
			stats.preReviewCount + stats.doubleBlindCount + stats.acceptedCount;
		const submissionTotal =
			stats.uploadCount + stats.publishedCount + stats.rejectedCount;
			...
			reviewStatus: [
				{
					...
					percentage: reviewTotal
						? Math.round((stats.preReviewCount / reviewTotal) * 100)
						: 0,
				},
				{
					name: 'Double-Blind',
					...
					percentage: reviewTotal
						? Math.round((stats.doubleBlindCount / reviewTotal) * 100)
						: 0,
				},
				{
					name: 'Accepted',
					...
					percentage: reviewTotal
						? Math.round((stats.acceptedCount / reviewTotal) * 100)
						: 0,
				},
			...
			submissionStatus: [
				{
					...
					percentage: submissionTotal
						? Math.round((stats.uploadCount / submissionTotal) * 100)
						: 0,
				},
				{
					name: 'Published',
					...
					percentage: submissionTotal
						? Math.round((stats.publishedCount / submissionTotal) * 100)
						: 0,
				},
				{
					name: 'Rejected',
					...
					percentage: submissionTotal
						? Math.round((stats.rejectedCount / submissionTotal) * 100)
						: 0,
				},
			].filter((item) => item.value > 0),
		};
	...
	const getChartData = (stats: any) => {
		...
		const reviewTotal =
			stats.preReviewCount + stats.doubleBlindCount + stats.acceptedCount;
		const submissionTotal = +stats.publishedCount + stats.rejectedCount;
	...
	return (
		<div className="p-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
				<div className="bg-white p-6 rounded-lg shadow-md">
					<h4 className="text-lg font-semibold mb-4">
						Monthly Submissions (January - June)
					</h4>
				...
				<div className="bg-white p-6 rounded-lg shadow-md">
					<h4 className="text-lg font-semibold mb-4">
						Monthly Submissions (July - December)
					</h4>
					<div className="h-[400px]">
						<DashboardCharts.BarChart
                ...
                <div key={key} className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold">{value}</p>
						...
						<div className="grid grid-cols-2 gap-6 mb-8">
							...
							<div>
								<h4 className="text-lg font-semibold mb-4">
									Yearly Submission Status
								</h4>
								<div className="h-[300px]">
									<DashboardCharts.PieChart
										data={submissionTypeDataYearly}
										chartType="STD"
										showPercentage={true}
									/>
								</div>
						...
						<div className="grid grid-cols-2 gap-6">
							<div className="bg-gray-50 p-4 rounded-lg">
								...
								<div className="h-[400px]">
									<DashboardCharts.BarChart
										data={yearlySubmissionsBar.firstHalf.map(
											(value, index) => ({
												name: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'][index],
												value,
											})
							...
							<div className="bg-gray-50 p-4 rounded-lg">
								...
								<div className="h-[400px]">
									<DashboardCharts.BarChart
										data={yearlySubmissionsBar.secondHalf.map(
											(value, index) => ({
												name: ['Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'][index],
												value,
											})
