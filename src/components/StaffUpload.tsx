...
const StaffUpload: React.FC = () => {
	...
	const confirmSubmission = async () => {
		...
		await sendMail({
			message: `<p>Hello ${manuscriptDetails.authors} <br/>Your manuscript entitled ${manuscriptDetails.title} is now in Pre-Review Stage.</p>`,
			recipients: [manuscriptDetails.authorEmail],
			subject: 'Manuscript Update: In Pre-Review Stage',
		});

		await sendMail({
			message: `<p>Hello ${selectedEditor.firstname} ${selectedEditor.lastname}, you are assigned to the manuscript entitled ${manuscriptDetails.title} by ${manuscriptDetails.authors}</p>`,
		...
		<div className="bg-white p-6 rounded-lg shadow-md">
			...
			<div className="grid grid-cols-2 gap-6 mb-6">
				<div className="col-span-1 bg-gray-100 p-4 rounded-lg">
					<h4 className="flex justify-center text-lg text-center font-semibold mb-2">
						Use Grammar Checker
					</h4>
				...
				<div className="col-span-1 bg-gray-100 p-4 rounded-lg">
					...
					<div className="flex items-center justify-center p-8">
						<img
							src="https://play-lh.googleusercontent.com/5zVQz4Y30vi5IXWRhh_HSJUIs8IZVbTmlIOLz95EnWwzNbgK04xn9PV3jwnqFa2yJGk"
							alt="smallpdf-icon.png"
							className="w-32"
						/>
					</div>
					<button
